...
class McpConfig:
    ...
    def get_mysql_workbench():
        mysql_server_params = StdioServerParams(
            ...
            args=[
                "--directory",
                "/Users/apple/Documents/Python_projects/Agentic-AI-AutoGen/.venv/lib/python3.13/site-packages",
                "run",
                "mysql_mcp_server"
            ],
            env={
    ...
    def get_filesystem_workbench():
        ...
        filesystem_server_params = StdioServerParams(
            command="npx",
            args=["-y", "@modelcontextprotocol/server-filesystem", "/Users/apple/Documents/Python_projects/Agentic-AI-AutoGen/Resource"],
            read_timeout_seconds=60
        )
